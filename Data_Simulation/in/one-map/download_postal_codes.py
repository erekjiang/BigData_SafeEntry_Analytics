...
if __name__ == '__main__':
	...
	parser.add_argument('--mincode', '-a', help='minimum of the scan range', type=int, default=680000)
	parser.add_argument('--maxcode', '-b', help='maximum of the scan range', type=int, default=680999)
